...
sample=$(sed -n "${i}p" /SAN/ugi/plant_genom/jiajucui/phylogeny/samplelist/tailocin46_55.txt)
...
OUTPUT_DIR="/SAN/ugi/plant_genom/jiajucui/tailocin_info/mydata_LPSgenesPA/results"
mkdir -p $OUTPUT_DIR
OUTPUT_FILE="${OUTPUT_DIR}/${sample}_gene_coverage.tsv"
...
# Header for output file
    ...
    # **Step 1: Compute total reference depth** -aa give all sites even depth is 0
