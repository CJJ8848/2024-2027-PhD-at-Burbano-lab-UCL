...
# Define directories
RESULTS_DIR="/SAN/ugi/plant_genom/jiajucui/tailocin_info/mydata_LPSgenesPA/results"
OUTPUT_TABLE="${RESULTS_DIR}/relative_depth_matrix.tsv"
