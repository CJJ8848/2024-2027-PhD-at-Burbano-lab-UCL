...
formatted_regions="/SAN/ugi/plant_genom/jiajucui/4_mapping_to_pseudomonas/shfortailocin/others/other_tailocininfo/tape/tapeformatted_regions.txt"
regions=()
...
for bam in "$bam_dir"/30.*q20.bam; do
